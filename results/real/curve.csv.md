...
Analysis-Command: cd results/real && python3 recompute.py | diff - analysis_summary.txt  (empty); the 12 per-cell rates are reproduced from eval_points.jsonl, the decay rows are arithmetic on the mismatch rows
Columns:
